/* ==============================================================
   VILLA EMILIA — ZAJEDNIČKA LOGIKA ZA SVE STRANICE
...
(function () {
  ...
  /* Putanja slike iz data.js. Podržane su lokalne datoteke ("assets/img/...")
     i pune adrese; ako se upiše samo Unsplash ID, složi se puna adresa. */
  var img = function (src, w, q) {
    if (/^(https?:)?\/\//.test(src) || src.indexOf("/") > -1) return src;
    return "https://images.unsplash.com/" + src + "?auto=format&fit=crop&w=" + (w || 800) + "&q=" + (q || 72);
  };
